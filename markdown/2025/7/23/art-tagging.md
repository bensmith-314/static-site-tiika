...
- Application(s) that I used to create the artwork
- Date of the art piece
- Whether or not stock imagery was used
- Whether or not any kind of generative image model was used
### Application
...
- For texturing, often this is done with a transparent cloud image (ex. Day [1361](/i/1361))
- Silhouettes of people running/standing (ex. Day [1268](/i/1268))
- Faces/People, often. through Adobe Illustrator's Image Trace Vector tool (ex. Day [321](/i/321))
- Direct implementation into the artwork (ex. Days [662](/i/662) and [704](/i/704))
...
I have used this only a few times, and I don't know if it necessarily counts as a generative model, but I've included it to be thorough. At least when I used it, it could generate a couple styles of trees based on a random seed and you could use them however you wanted. 
#### This Person/Chemical Does Not Exist
[thispersondoesnotexist.com](https://thispersondoesnotexist.com) and [thischemicaldoesnotexist.com](https://web.archive.org/web/20211010221146/https://thischemicaldoesnotexist.com/) (which seems to no longer exist) both predate what generally is accepted as modern generative models. I have also included these since they aren't creations of my own, but don't qualify as stock photography. These sites have collections of images that have been generated (I can only assume as a pre-generated collection), that gives you a random one each time you reload the page. I have used thispersondoesnotexist twice (Days [236](/i/236) and [270](/i/270)) and thischemicaldoesnotexist once (Day [391](/i/391))
#### Stable Diffusion Via DiffusionBee
I, like many in the Apple community, played around with DiffusionBee when it first came out. Not many of the things I created in DiffusionBee worked their way into my published art, I personally think each of them was tastefully created and weren't overly reliant on the models from an artistic perspective (Days [392](/i/392), [572](/i/572), [585](/i/585))
...
As I look back on the artwork I created using this, my favorites are ones that I still put a lot of effort into (Days [991](/i/991), [993](/i/993), [1055](/i/1055), and [1068](/i/1068)) and the ones I like the least are ones that had very little added to them beyond a base image (Days [1070](/i/1070), [1107](/i/1107), [1139](/i/1139), [1161](/i/1161), [1226](/i/1226), [1227](/i/1127), etc.). As I worked with this tool more, I liked it less. I found myself getting lazier with the creation process as I used it more. 

This, like stock photography isn't inherently bad in my eyes. But it is a tool to be wary of. When I used it well, it has helped me to create some of my all time favorite artwork, but on the flip side, many of my personally most despised and disliked pieces I have were created using this model. 

The last art piece I made using any kind of generative image model was on Day [1248](/i/1248) nearly a year ago. I won't say that I will never use them again, the future holds a lot of mysteries, but for the foreseeable future, I don't have any plans to use these models other than out of curiosity and exploration.