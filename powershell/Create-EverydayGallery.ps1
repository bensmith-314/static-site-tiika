...
$everydaysSmallPath = [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "../../tiika/everydays_small/"))
$everydayGalleryPath = [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot "../../tiika/everyday.html"))
