...
echo "Syncing images from source to working drectory..."

# Define paths using realpath-style resolution (create if needed first)
WEBSITE_IMAGES_ORIGIN="/Users/bensmith/git/Website Images/"
...
resized_count=0
for img in "$EVERYDAYS_TIIKA_PATH"*.jpg; do
    filename=$(basename "$img")
    target="$EVERYDAYS_SMALL_TIIKA_PATH$filename"
